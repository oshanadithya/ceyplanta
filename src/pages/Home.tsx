  ...
  return (
    <div className="home">
      ...
      >
        ...
        <p>
          From nutritious organic microgreens, ceylon cinnamon, ceylon tea and wellness products to agriculture & farm-to-factory supply solutions — Ceyplanta connects farms, factories, and customers with reliable, sustainable solutions.
        </p>
